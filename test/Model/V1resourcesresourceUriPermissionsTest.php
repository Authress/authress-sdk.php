<?php
/**
 * V1resourcesresourceUriPermissionsTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V1resourcesresourceUriPermissionsTest Class Doc Comment
 *
 * @category    Class
 * @description V1resourcesresourceUriPermissions
 * @package     AuthressClient
 * @author      Authress Developers
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1resourcesresourceUriPermissionsTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "V1resourcesresourceUriPermissions"
     */
    public function testV1resourcesresourceUriPermissions()
    {
    }
