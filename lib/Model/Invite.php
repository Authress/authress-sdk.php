...
'statements' => 'getStatements'    ];
     ...
     * Sets statements
     *
     * @param \AuthressClient\Model\V1recordsStatements[] $statements A list of statements which match roles to resources. The invited user will all statements apply to them
     *
     * @return $this
     */
