 ...
 * @link     https://authress.io/app/#/api
 */
class UserToken implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserToken';
...
'token_id' => 'string',
'token' => 'string',
'links' => '\AuthressSdk\Model\UserTokenLinks'    ];
...
'links' => 'getLinks'    ];
     ...
     * Gets links
     *
     * @return \AuthressSdk\Model\UserTokenLinks
     */
     ...
     * Sets links
     *
     * @param \AuthressSdk\Model\UserTokenLinks $links links
     *
     * @return $this
     */
