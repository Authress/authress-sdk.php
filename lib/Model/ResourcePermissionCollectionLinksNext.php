<?php
/**
 * ResourcePermissionCollectionLinksNext
...
/**
 * ResourcePermissionCollectionLinksNext Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://authress.io/app/#/api
 */
class ResourcePermissionCollectionLinksNext implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourcePermissionCollection_links_next';
...
'rel' => 'getRel'    ];
     ...
     * Sets href
     *
     * @param string $href The absolute url pointing to the reference resource.
     *
     * @return $this
     */
     ...
     * Sets rel
     *
     * @param string $rel Optional property indicating the type of link if it is not a default IANA approved global link relation.
     *
     * @return $this
     */
