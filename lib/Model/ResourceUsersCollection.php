...
/**
 * ResourceUsersCollection Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://authress.io/app/#/api
 */
class ResourceUsersCollection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceUsersCollection';
...
'links' => 'getLinks'    ];
     ...
     * Sets users
     *
     * @param \AuthressSdk\Model\V1recordsUsers[] $users A list of users
     *
     * @return $this
     */
