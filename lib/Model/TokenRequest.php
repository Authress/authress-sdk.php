...
'expires' => 'getExpires'    ];
     ...
     * Sets statements
     *
     * @param \AuthressClient\Model\V1recordsStatements[] $statements A list of statements which match roles to resources. The token will have all statements apply to it.
     *
     * @return $this
     */
