...
class AccessRecordsApi
{
     ...
     *
     * @param  \AuthressClient\Model\Body6 $body body (required)
     *
     ...
     * Claim a resource by an allowed user.
     *
     * @param  \AuthressClient\Model\Body6 $body (required)
     *
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create a new invite.
     *
     * @param  \AuthressClient\Model\Body3 $body body (required)
     *
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Create a new invite.
     *
     * @param  \AuthressClient\Model\Body3 $body (required)
     *
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \AuthressClient\Model\Body1 $body body (required)
     *
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AuthressClient\Model\InlineResponse2006
     */
     ...
     * Create a new access record.
     *
     * @param  \AuthressClient\Model\Body1 $body (required)
     *
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AuthressClient\Model\InlineResponse2006, HTTP status code, HTTP response headers (array of strings)
     */
    public function createRecordWithHttpInfo($body)
    {
        $returnType = '\AuthressClient\Model\InlineResponse2006';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AuthressClient\Model\InlineResponse2006',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AuthressClient\Model\InlineResponse2005
     */
     ...
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AuthressClient\Model\InlineResponse2005, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRecordsWithHttpInfo($limit = '20', $cursor = null, $filter = null, $status = null)
    {
        $returnType = '\AuthressClient\Model\InlineResponse2005';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AuthressClient\Model\InlineResponse2005',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \AuthressClient\Model\Body2 $body body (required)
     * @param  string $record_id The identifier of the access record. (required)
     *
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Update an access record.
     *
     * @param  \AuthressClient\Model\Body2 $body (required)
     * @param  string $record_id The identifier of the access record. (required)
     *
     * @throws \AuthressClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
